...
class GraphicsSharedMemory(ctypes.Structure):
    ...
    _fields_ = [
        ...
        ("current_time", ctypes.c_wchar_p * 15),
        ("last_time", ctypes.c_wchar_p * 15),
        ("best_time", ctypes.c_wchar_p * 15),
        ("split", ctypes.c_wchar_p * 15),
        ...
        ("tyre_compound", ctypes.c_wchar_p * 33),
        ...
        ("delta_laptime", ctypes.c_wchar_p * 15),
        ("i_delta_laptime", ctypes.c_int),
        ("estimated_laptime", ctypes.c_wchar_p * 15),
        ...
        ("track_status", ctypes.c_wchar_p * 33),
